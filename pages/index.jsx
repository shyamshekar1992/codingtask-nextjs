    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      <div className="flex space-x-4">
        ...
        <div className="flex-1">
          ...
          />
          {errors.A && <p className="text-red-500 text-xs mt-2">{errors.A.message}</p>}
        </div>
        ...
        <div className="flex-1">
          ...
          />
          {errors.B && <p className="text-red-500 text-xs mt-2">{errors.B.message}</p>}
        </div>
              ...
              <div className="w-full bg-gray-200 rounded-full">
                ...
                >
                  <span className="text-teal-100 font-semibold inline-block py-1 px-2 uppercase rounded-full">
                    {progress}% {/* Display percentage inside the loading bar */}
                  </span>
                </div>
              </div>
            </div>
          ...
          <div key={index} className="flex justify-between items-center">
            <span className="text-lg font-medium text-gray-700">
              {operation === "add" ? "A + B" :
                ...
                operation === "divide" ? "A / B" : operation}
            </span>
